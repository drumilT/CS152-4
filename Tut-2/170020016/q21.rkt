...
(define (chec lst) ( and ( equal? (sort (car lst) <) '( 1 2 3 4 5 6 7 8 9)) ( equal? (sort (cadr lst) < ) '( 1 2 3 4 5 6 7 8 9))
                         ( equal? (sort (caddr lst) <) '( 1 2 3 4 5 6 7 8 9))))
...
(define (sudoku-check lst)
  (define (helper lst1 )
   ...
   ( and (chec (helper (car (club3 lst)))) (chec (helper (cadr (club3 lst)))) (chec (helper (caddr (club3 lst))))))